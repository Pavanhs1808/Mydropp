  ...
  return (
    <header className="bg-white shadow-sm sticky top-0 z-50">
      <div className="max-w-7xl mx-auto">
        {/* Top Bar */}
        <div className="hidden md:flex justify-between items-center py-2 px-4 text-sm text-gray-600 border-b">
        ...
        <nav className="hidden md:block bg-gray-100 border-t">
          <div className="flex justify-between px-4">
            ...
            <Link 
              href="/category/sale" 
              className="flex items-center px-3 py-3 text-sm font-medium text-secondary hover:text-secondary-dark"
            >
              Sale
            </Link>
          </div>
